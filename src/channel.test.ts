...
describe ('Testing channelLeaveV1', () => {
    ...
    beforeEach(() => {
      ...
      test ('user is not a member of the channel', () => {
        const user1 = requestAuthRegister("wrongemail@gmail.com", "badpassword", "wrong", "email");
        const user2 = requestAuthRegister("testtest@gmail.com", "badpassword", "wrong1", "email1");
        const channel1 = requestChannelscreate(user1.token, 'test',true).channelId;
...
describe ("Testing the addowner function", () => {
    ...
    beforeEach(() => {
      ...
      test ('Adding a user as an owner to the channel', () => {
        const user1 = requestAuthRegister("wrongemail@gmail.com", "badpassword", "wrong", "email");
        const user2 = requestAuthRegister("wrongmail@gmail.com", "badpassword", "wrong", "email");
        const channel1 = requestChannelscreate(user1.token, 'test',true).channelId;
      ...
      test('should return error with uId already an owner', () => {
        const user2 = requestAuthRegister("wrongemail@gmail.com", "badpassword", "wrong", "email");
      ...
      test('should return error with user without owner permissions', () => {
        const user1 = requestAuthRegister("wrongemail@gmail.com", "badpassword", "wrong", "email");
        const channel1 = requestChannelscreate(user1.token, 'test',true).channelId;
        const user2 = requestAuthRegister("wronge3mail@gmail.com", "badpassword", "wrong", "email");
        const user3 = requestAuthRegister("wronge2mail@gmail.com", "badpassword", "wrong2", "email2");
        requestChannelJoin(user3.token, channel1);
        requestChannelJoin(user2.token, channel1);
